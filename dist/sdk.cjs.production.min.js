...
let v,
  y = '0xa856464ae65f7619087bc369daaf7e387dae1e5af69cfa7935850ebf754b04c1',
  w = i.BigInt(1e3),
  T = i.BigInt(0),
  g = i.BigInt(1),
  k = i.BigInt(2),
...
let tt,
  ...
  nt =
    ...
    (J[42161] = new z(42161, '0x82af49447d8a07e3bd95bd0d56f35241523fbab1', 18, 'WETH', 'Wrapped Ether')),
          ...
          case exports.TradeType.EXACT_INPUT:
            n
              ? ((o = l ? 'swapExactETHForTokensSupportingFeeOnTransferTokens' : 'swapExactETHForTokens'),
                (i = [d, p, s, '0x0000000000000000000000000000000000000000', f]),
                (a = c))
              : r
              ? ((o = l ? 'swapExactTokensForETHSupportingFeeOnTransferTokens' : 'swapExactTokensForETH'),
                (i = [c, d, p, s, '0x0000000000000000000000000000000000000000', f]),
                (a = '0x0'))
          ...
          case exports.TradeType.EXACT_OUTPUT:
            l && u(!1),
              n
                ...
                : r
                ? ((o = 'swapExactTokensForETHSupportingFeeOnTransferTokens'),
                  (i = [d, c, p, s, '0x0000000000000000000000000000000000000000', f]),
                  (a = '0x0'))
                : ((o = 'swapExactTokensForTokensSupportingFeeOnTransferTokens'),
                  (i = [d, c, p, s, '0x0000000000000000000000000000000000000000', f]),
                  (a = '0x0'))
        }
