...
const FACTORY_ADDRESS = '0x6EcCab422D763aC031210895C81787E87B43A652'
const INIT_CODE_HASH = '0xa856464ae65f7619087bc369daaf7e387dae1e5af69cfa7935850ebf754b04c1'
    ...
    switch (trade.tradeType) {
      case TradeType.EXACT_INPUT:
        if (etherIn) {
          ...
          args = [amountOut, path, to, '0x0000000000000000000000000000000000000000', deadline]
          value = amountIn
        } else if (etherOut) {
          methodName = useFeeOnTransfer ? 'swapExactTokensForETHSupportingFeeOnTransferTokens' : 'swapExactTokensForETH' // (uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)

          args = [amountIn, amountOut, path, to, '0x0000000000000000000000000000000000000000', deadline]
          value = ZERO_HEX
        } else {
      ...
      case TradeType.EXACT_OUTPUT:
        ...
        if (etherIn) {
          ...
          methodName = 'swapExactTokensForETHSupportingFeeOnTransferTokens' // (uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline)

          args = [amountOut, amountIn, path, to, '0x0000000000000000000000000000000000000000', deadline]
          value = ZERO_HEX
        } else {
          methodName = 'swapExactTokensForTokensSupportingFeeOnTransferTokens' // (uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline)
